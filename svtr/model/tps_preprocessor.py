...
class TPStransform(nn.Module):
    ...
    def _build_output_control_points(self, num_control_points: int,
...
class STN(nn.Module):
    ...
    def init_stn(self, stn_fc2: nn.Linear) -> None:
        ...
        with torch.no_grad():
            stn_fc2.weight.zero_()
            stn_fc2.bias.copy_(torch.tensor(ctrl_points).view(-1))
    ...
    def forward(self, img: torch.Tensor) -> torch.Tensor:
        ...
        transformed_image = self.tps(img, points)
